...
export class BorrowerOperations extends ethereum.SmartContract {
  ...
  sYETIAddress(): Address {
    let result = super.call("sYETIAddress", "sYETIAddress():(address)", []);

    return result[0].toAddress();
  }

  try_sYETIAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall("sYETIAddress", "sYETIAddress():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class RepayYUSDCall extends ethereum.Call {
  get inputs(): RepayYUSDCall__Inputs {
    return new RepayYUSDCall__Inputs(this);
  }

  get outputs(): RepayYUSDCall__Outputs {
    return new RepayYUSDCall__Outputs(this);
  }
}

export class RepayYUSDCall__Inputs {
  _call: RepayYUSDCall;

  constructor(call: RepayYUSDCall) {
    this._call = call;
  }
...
export class RepayYUSDCall__Outputs {
  _call: RepayYUSDCall;
...
export class WithdrawYUSDCall extends ethereum.Call {
  get inputs(): WithdrawYUSDCall__Inputs {
    return new WithdrawYUSDCall__Inputs(this);
  }

  get outputs(): WithdrawYUSDCall__Outputs {
    return new WithdrawYUSDCall__Outputs(this);
  }
}

export class WithdrawYUSDCall__Inputs {
  _call: WithdrawYUSDCall;

  constructor(call: WithdrawYUSDCall) {
    this._call = call;
  }
...
export class WithdrawYUSDCall__Outputs {
  _call: WithdrawYUSDCall;
