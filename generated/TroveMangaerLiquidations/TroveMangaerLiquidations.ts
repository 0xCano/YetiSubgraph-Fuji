...
export class TroveMangaerLiquidations extends ethereum.SmartContract {
  static bind(address: Address): TroveMangaerLiquidations {
    return new TroveMangaerLiquidations("TroveMangaerLiquidations", address);
  }
