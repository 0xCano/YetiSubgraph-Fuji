...
export class BorrowOperation extends ethereum.SmartContract {
  static bind(address: Address): BorrowOperation {
    return new BorrowOperation("BorrowOperation", address);
  }
